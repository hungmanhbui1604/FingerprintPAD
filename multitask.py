...
from models.multitask_models import get_model
from train_utils.metrics import find_optimal_threshold
from train_utils.one_epochs import train_one_epoch, validate_one_epoch, test_one_epoch
...
if __name__ == '__main__':
    ...
    model, spoof_criterion, material_criterion, optimizer, scheduler = get_model(
    ...
    # Testing phase
    labels, probabilities = test_one_epoch(model, test_loader, device)
